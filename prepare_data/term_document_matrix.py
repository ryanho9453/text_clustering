...
module_path = '/Users/ryanho/Documents/python/focal/text_clustering/find_keyword/prepare_data/'
...
class TermDocumentMatrix:
    ...
    def __init__(self, config):
        ...
        self.whitelist = self._read_whitelist(os.path.join(script_path, 'whitelist.txt'))
    ...
    def create(self, save_matrix=False):
        ...
        self._gen_word_id_converter(word2id)
    ...
    def __gen_df_dict(self, td_matrix, vocab_size):
        ...
        for w in range(vocab_size):
            ...
            df_dict[id2word[w]] = int(df) / self.n_docs
